export default {
  ...
  'app.register.error-code': '错误码是 ',
  'validation.email.required': '请输入邮箱地址！',
  'validation.email.wrong-format': '邮箱地址格式错误！',
  'validation.username.required': '请输入用户名!',
  'validation.username.length': '用户名的长度必须是4至20个字符。',
  'validation.username.format': '用户名只能是数字和字母。',
  'validation.password.required': '请输入密码！',
  'validation.password.length': '密码的长度必须是4至20个字符。',
  'validation.password.twice': '两次输入的密码不匹配!',
  'validation.password.strength.msg':
    '请至少输入 8 个字符，不能多于20个字符。请不要使用容易被猜到的密码。',
  'validation.password.strength.long': '强度：太长',
  'validation.password.strength.pass': '强度：中',
