export default {
  ...
  'app.login.error-code': 'error code is ',
  ...
  'app.register.error-code': 'error code is ',
  ...
  'validation.username.length': 'The length of username needs 4 to 20 characters.',
  'validation.username.format': 'Username can only be letters and numbers.',
  'validation.password.required': 'Please enter your password!',
  'validation.password.length': 'The length of password needs 4 to 20 characters.',
  ...
  'validation.password.strength.long': 'Strength: too long',
  'validation.password.strength.pass': 'Strength: pass',
